...
.board-tile.LS,
.board-tile.RS {
    background: #69f0ae; /* Ярко-зелёный */
    color: black;
}

.board-tile.LB,
.board-tile.RB {
    background: #ff80ab; /* Ярко-розовый */
    color: black;
}


/* Тёмная тема — насыщенные цвета */
body.dark .board-tile.LS { background: #00c853; color: black; }
body.dark .board-tile.LB { background: #c2185b; color: black; }
body.dark .board-tile.RS { background: #4ddf89; color: black; }
body.dark .board-tile.RB { background: #d63c76; color: black; }
...
<main>
    ...
    <div class="input-row">
        <input type="text" id="input" placeholder="np. 1LS 84 Update" autocomplete="off" />
